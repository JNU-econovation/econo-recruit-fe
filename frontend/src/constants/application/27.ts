...
export const APPLICATION_TIMELINE: ApplicationTimeline = {
  ...
  time: [
    {
      startTime: new Date(2024, 3, 20, 10, 0, 0),
      endTime: new Date(2024, 3, 20, 19, 0, 0),
    },
    {
      startTime: new Date(2024, 3, 21, 10, 0, 0),
      endTime: new Date(2024, 3, 21, 19, 0, 0),
    },
    {
      startTime: new Date(2024, 3, 22, 10, 0, 0),
      endTime: new Date(2024, 3, 22, 19, 0, 0),
    },
  ],
  disableTime: [],
};
