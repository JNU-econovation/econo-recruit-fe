...
export const APPLICATION_MANAGER: ApplicationQuestion[] = [
  {
    ...
    subtitle:
      "지원서 및 포트폴리오에 거짓이나 과장된 사항 적발 시, 불이익이 발생할 수 있습니다.\n\n저희 동아리는 매주 금요일 17시에 진행되는 주간발표에 필수로 참여해야 하며, 한 학기 동안 프로젝트를 진행해야 해서 많은 시간을 학기 중에 할애하게 됩니다. 이 점 참고하여 지원 바랍니다.\n\n(주간발표 : 프로젝트를 진행하며 자신이 배웠던 지식을 동아리원들과 나누는 시간입니다.)",
  ...
  },
  {
    ...
    subtitle:
      "본인이 생각하는 기획자는 무엇인지, 기획자를 희망하게 된 이유는 무엇인지 구체적으로 작성해주세요.",
    direction: "horizontal",
    require: true,
    nodes: [
      {
  ...
  },
  {
    ...
    subtitle:
      "단, 지원자 분의 포트폴리오 링크 접근 권한을 '꼭' 열어주세요. 만약 접근 권한이 없을 경우 불이익이 있을 수 있습니다.\n포트폴리오 제출물에 대한 잘못된 권한 설정으로, 파일이 열리지 않는 것은 지원자 본인의 책임입니다. 제출 전에 한번 더 확인해 주세요.",
...
export const APPLICATION_NAVBAR_MANAGER = [
  ...
  { id: 9, title: "무언가 깊게 빠지거나 파고 들어본 적이 있나요?" },
  {
    id: 10,
